...
//fonte: https://github.com/felipey2010/PhilipMahama_Lista_2_SO_RR_2019/blob/master/primos_threads.c

//Gerar entre 0 and 10000
void* p1_thread(){
    int i;
    for(i = 0; i < 10000; i++){
        if(i%2 != 0)
